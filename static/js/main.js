    ...
    jQuery(document).ready(function ($) {
        ...
        $(window).on('scroll', function () {
            ...
            if($('.all-products-area').length > 0) {
                if((($(window).scrollTop() + $('.header-fixed').height()) > $('.all-products-area').offset().top) && (($(window).scrollTop() + $('.header-fixed').height() + $('.product-menu-fixed-area').height()) < ( $('.all-products-area').offset().top + $('.all-products-area').height() - 100 ))) {
        ...
        $(document).on("click", ".drawer-menu-backdrop, .drawer-menu-close, .mobile-main-menu ul li a", function () {
            $(".drawer-menu-area").removeClass("active");
        });
        ...
        //
        // $(document).on('click', '.top-bar-language-country-currency-area .dropdown-menu', function (e) {
        //     e.stopPropagation();
        // });
        //
        // // SELECT 2
        ...
        $(document).on("click", ".product-menu-sticky-area .nav.nav-tabs .nav-item.nav-link", function () {
            $('html, body').animate({

...
const QueryForm = dynamic(() => import('../components/faq/QueryForm'), {
    loading: () => {
        return <Skeleton count={25} />;
    },
    ssr: false,
});
const FaqCard = dynamic(() => import('../components/faq/FaqCard'), {
    loading: () => {
...
const faqs = [
    {
        ...
        answer:
            'The instructions to activate your account will be sent to your email once you have submitted the registration form. If you did not receive this email, your email service provider’s mailing software may be blocking it. You can try checking your junk / spam folder or contact us at help@mystore.az',
    },
    {
        id: 2,

                                ...
                                <div className="common-padded-box-header">
                                    <div className="product-menu-sticky-area">
                                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                            <a
                                                className="nav-item nav-link featured blue active"
                                                data-toggle="tab"
                                                href="#daily-discover"
                                                role="tab"
                                                aria-controls="nav-daily-discover"
                                                aria-selected="true">
                                                Featured
                                            </a>
                                            <a
                                                className="nav-item nav-link latest red"
                                                data-toggle="tab"
                                                href="#daily-discover"
                                                role="tab"
                                                aria-controls="nav-daily-discover"
                                            ...
                                            <a
                                                className="nav-item nav-link discounts green"
                                                data-toggle="tab"
                                                href="#daily-discover"
                                                role="tab"
                                                aria-controls="nav-daily-discover"
                                            ...
                                            <a
                                                className="nav-item nav-link cashback yellow"
                                                data-toggle="tab"
                                                href="#daily-discover"
                                                role="tab"
                                                aria-controls="nav-daily-discover"
                                            ...
                                            <a
                                                className="nav-item nav-link comeback purple"
                                                data-toggle="tab"
                                                href="#daily-discover"
                                                role="tab"
                                                aria-controls="nav-daily-discover"
                    ...
                    <div className="col-lg-12">
                        <div className="tab-content product-tab-content">
                            <div
                                ...
                                id="daily-discover"
                                role="tabpanel"
                                aria-labelledby="daily-discover-tab">
